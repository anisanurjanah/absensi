...
@push('style')
    ...
    <link rel="stylesheet"
        href="{{ asset('library/chart.js/dist/Chart.min.css') }}">
@endpush
...
@push('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const days = {!! isset($last7Days) ? $last7Days : '[]' !!};
            const attendanceData = {!! isset($attendanceSummary) ? $attendanceSummary : '[]' !!};
                    ...
                    tooltips: {
                        callbacks: {
                            label: function(tooltipItem, data) {
                                return tooltipItem.value + ' employees';
                            }
                        }
                    }
                }
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="card card-statistic-1">
                        ...
                        <div class="card-wrap">
                            ...
                            <div class="card-body">
                                {{ isset($totalEmployees) ? $totalEmployees : 0 }}
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="card card-statistic-1">
                        ...
                        <div class="card-wrap">
                            ...
                            <div class="card-body">
                                {{ isset($presentToday) ? $presentToday : 0 }}
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="card card-statistic-1">
                        ...
                        <div class="card-wrap">
                            ...
                            <div class="card-body">
                                {{ isset($absentToday) ? $absentToday : 0 }}
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-8 col-md-12 col-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <canvas id="attendanceChart" height="182"></canvas>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <ul class="list-unstyled list-unstyled-border">
                                @foreach(isset($recentActivity) ? $recentActivity : [] as $activity)
                                <li class="media">
                                    <img class="rounded-circle mr-3" width="50"
                                        src="{{ $activity->user->image_url ? asset($activity->user->image_url) : asset('img/avatar/avatar-1.png') }}"
                                        alt="avatar">
                                    <div class="media-body">
                                        <div class="float-right">{{ $activity->created_at->diffForHumans() }}</div>
                                        <div class="media-title">{{ $activity->user->name }}</div>
                                        <span class="text-small text-muted">
                                            {{ $activity->time_out ? 'Checked out' : 'Checked in' }} on {{ \Carbon\Carbon::parse($activity->date)->format('M d, Y') }} at
                                            {{ $activity->time_out ? \Carbon\Carbon::parse($activity->time_out)->format('H:i') : \Carbon\Carbon::parse($activity->time_in)->format('H:i') }}
                                        </span>
                                    </div>
                                </li>
                                @endforeach
                            ...
                            <div class="pt-1 pb-1 text-center">
                                <a href="{{ route('attendances.index') }}" class="btn btn-primary btn-lg btn-round">View All</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            @foreach(isset($departmentStats) ? $departmentStats : [] as $dept)
                            <div class="mb-4">
                                <div class="text-small font-weight-bold text-muted float-right">{{ $dept->total }}</div>
                                <div class="font-weight-bold mb-1">{{ $dept->department }}</div>
                                <div class="progress" data-height="3">
                                    <div class="progress-bar" role="progressbar"
                                        data-width="{{ isset($totalEmployees) && $totalEmployees > 0 ? ($dept->total / $totalEmployees) * 100 : 0 }}%"
                                        aria-valuenow="{{ isset($totalEmployees) && $totalEmployees > 0 ? ($dept->total / $totalEmployees) * 100 : 0 }}"
                                        aria-valuemin="0"
                ...
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="summary">
                                <div class="summary-info bg-success text-white p-3">
                                    <h4 class="text-white">Today's Attendance Rate</h4>
                                    <div>{{ isset($totalEmployees) && isset($presentToday) && $totalEmployees > 0 ? number_format(($presentToday / $totalEmployees) * 100, 1) : 0 }}% Present</div>
                                    <div class="d-block mt-2">
                                        <a href="{{ route('attendances.index') }}" class="text-white">View Details</a>
                                    </div>
                                </div>
                                <div class="summary-item mt-4">
                                    ...
                                    <ul class="list-unstyled list-unstyled-border">
                                        <li class="media">
                                            <div class="media-body">
                                                <div class="media-right text-primary">{{ $presentToday }}</div>
                                                <div class="media-title">Present Today</div>
                                            </div>
                                        </li>
                                        <li class="media">
                                            <div class="media-body">
                                                <div class="media-right text-danger">{{ $absentToday }}</div>
                                                <div class="media-title">Absent Today</div>
                                            </div>
                                        </li>
                                        <li class="media">
                                            <div class="media-body">
                                                <div class="media-right text-warning">{{ $lateToday }}</div>
                                                <div class="media-title">Late Today</div>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
